...
def group_by_all():
    ...
    assert pyunit_utils.compare_frames(result_all_NA[g_iris_virginica_petal_wid.keys()],
                                       result_rm_NA[g_iris_virginica_petal_wid.keys()], 0, 0, 1e-6,
                                       strict=False, compare_NA=False), "H2O group_by() command is not working."
    assert pyunit_utils.compare_frames(result_all_NA[g_iris_virginica_petal_wid.keys()],
                                       result_ignore_NA[g_iris_virginica_petal_wid.keys()], 0, 0, 1e-6,
                                       strict=False, compare_NA=False), "H2O group_by() command is not working."
    ...
    assert_all_NAs(result_all_NA, g_iris_setosa_sepal_len.keys())  # check sepal_len
    assert_all_NAs(result_all_NA, g_iris_versicolor_sepal_wid.keys())  # check sepal_wid
    assert_all_NAs(result_all_NA, g_iris_versicolor_petal_len_NA_ignore.keys())   # check petal_len
