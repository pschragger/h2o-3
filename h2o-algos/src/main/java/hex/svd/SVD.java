...
import static water.util.ArrayUtils.createScoringHistoryTableDR;
    ...
    public void computeImpl() {
      ...
      try {
        ...
        if(_parms._svd_method == SVDParameters.Method.GramSVD) {
          ...
          String[] fieldNames = {"Timestamp", "Duration", "Iteration", "err", "Principal Component #"};;
          model._output._scoring_history = createScoringHistoryTableDR(fieldNames, model._output._training_time_ms,
                  model._output._history_err, model._output._history_eigenVectorIndex,
          ...
          String[] fieldNames = {"Timestamp", "Duration", "Iteration", "average SEE"};
          model._output._scoring_history = createScoringHistoryTableDR(fieldNames, model._output._training_time_ms,
                  model._output._history_average_SEE, null,
